...
public class iOSActions extends TrCardActions
{
    ...
    static {
        ...
        WARNING_TEXT_TEMPLATE = "xpath://XCUIElementTypeOther[contains(@name, '{WARNING_TEXT}')]";
        ...
        TOP_BUTTON_TEMPLATE = "xpath://XCUIElementTypeButton[contains(@name, '{TOP_BUTTON_NAME}')]";
        ...
        PAYMENT_RADIO_BUTTON_TEMPLATE = "xpath://XCUIElementTypeOther[contains(@name, '{PAYMENT_RADIO_BUTTON_TEXT}')]";
        SBP_PAYMENT_RADIO_BUTTON_TEMPLATE = "xpath://XCUIElementTypeImage[contains(@name, '{SBP_PAYMENT_RADIO_BUTTON_TEXT}')]";
